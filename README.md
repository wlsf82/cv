...
_Stack:_ NodeJS, JavaScript, TypeScript, React, GraphQL, Apollo, Cypress, Protractor, and BackstopJS.
...
The school already have more than **700** students and four courses, one with an introduction to test automation (theoretic and available for free), two about visual regression testing with BackstopJS (hands-on - one paid and one free), and another one about test architecture with the Protractor framework (also hands-on and paid).
...
Introduction to JavaScript and Variables, Control Flow, Functions and Higher-order Functions, Scope, Arrays, Loops, Iterators, Objects, Advanced Objects,  Classes, Browser Compatibility and Transpilation, Intermediate JavaScript Modules, and finally, Requests (with ES5, ES6 and ES7 syntax).
