...
The school already have more than **800** students and four courses, one with an introduction to test automation (theoretic and available for free), two about visual regression testing with BackstopJS (hands-on - one paid and one free), and another one about test architecture with the Protractor framework (also hands-on and paid).
